...
| **US04**            | Ver Disponibilidad de Estacionamiento          | **Como** visitante de la plataforma PARKINGNOW, **deseo** ver la disponibilidad de estacionamientos en tiempo real utilizando sensores infrarrojos **para** seleccionar el mejor lugar para estacionar antes de llegar. | **Escenario 01**: **Given** que estoy buscando estacionamiento en PARKINGNOW, **When** ingreso una ubicación, **Then** debería ver la disponibilidad en tiempo real de los espacios de estacionamiento cercanos detectada por sensores infrarrojos. <br> **Escenario 02**: **Given** que la disponibilidad cambia, **When** un espacio se ocupa o se desocupa, **Then** la información en la página debe actualizarse automáticamente. | **EP04**                      |
...
| **US08**            | Personalización de Preferencias de Usuario     | **Como** visitante de la plataforma PARKINGNOW, **deseo** poder personalizar la apariencia de la landing page (temas, idioma) **para** adaptar la experiencia de búsqueda y reserva de estacionamiento según mis preferencias. | **Escenario 01**: **Given** que prefiero un tema oscuro en PARKINGNOW, **When** selecciono "Tema Oscuro" en las preferencias, **Then** toda la interfaz debe cambiar a tema oscuro. <br> **Escenario 02**: **Given** que prefiero un idioma diferente, **When** selecciono "Español" como idioma, **Then** toda la interfaz debe traducirse automáticamente al español. | **EP08**                      |
...
| **US42**            | Implementación de Funcionalidades de Accesibilidad | **Como** developer de frontend de PARKINGNOW, **necesito** mejorar la accesibilidad de la plataforma **para** asegurar que todas las funcionalidades sean utilizables por personas con discapacidades. | **Escenario 01**: **Given** que soy developer de frontend, **When** implemento mejoras de accesibilidad, **Then** la plataforma debe cumplir con los estándares de accesibilidad (WCAG). <br> **Escenario 02**: **Given** que un usuario utiliza un lector de pantalla, **When** navega por la plataforma, **Then** todas las funcionalidades deben ser accesibles y comprensibles. | **EP01**                      |
...
| **US52**            | Creación de Funcionalidad de Auto-Completado   | **Como** developer de frontend de PARKINGNOW, **necesito** implementar una funcionalidad de auto-completado en campos de búsqueda **para** mejorar la experiencia de usuario y agilizar el proceso de búsqueda. | **Escenario 01**: **Given** que soy developer de frontend, **When** implemento la funcionalidad de auto-completado, **Then** los campos de búsqueda deben sugerir resultados automáticamente a medida que los usuarios escriben. <br> **Escenario 02**: **Given** que se selecciona un resultado sugerido, **When** el usuario hace clic en la sugerencia, **Then** la búsqueda debe realizarse automáticamente con el término seleccionado. | **EP10**                      |
